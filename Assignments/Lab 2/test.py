...
try:
	...
	script_path = glob.glob("./lab2.py")[0]
...
try:
	format_date = module.format_date
	split_by_delimiter = module.split_by_delimiter
	check_perfect_squares = module.check_perfect_squares
except:
...
def test_check_perfect_squares():
	assert check_perfect_squares([(1, 1), (2, 4), (3, 9)]) == True
	assert check_perfect_squares([(1, 1), (2, 4), (3, 8)]) == False
	assert check_perfect_squares([(1, 1), (2, 4), (3, 9), (4, 16)]) == True
	assert check_perfect_squares([(1, 1), (2, 4), (3, 9), (4, 15)]) == False
	assert check_perfect_squares([(1, 1), (2, 4), (3, 9), (4, 16), (5, 25)]) == True
